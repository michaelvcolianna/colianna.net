...
class Login_Preventer {
	...
	/** @var User_Authentication_Configuration_Checker */
	 ...
	 * @param User_Authentication_Configuration_Checker $authentication_configuration_checker
	 * @param Error_Factory                             $error_factory
	 */
	...
	public function prevent_login_if_user_uses_twofactor_authentication() {
		...
		return $this->error_factory->create_wp_error(
	...
	private function is_user_using_twofactor_authentication() {
		return $this->authentication_configuration_checker->is_user_using_twofactor_authentication(
			$this->authenticating_user->ID
		);
	}
}
