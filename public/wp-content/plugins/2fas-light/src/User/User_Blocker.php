...
class User_Blocker {
	...
	public function is_blocked() {
		return $this->time->get_current_timestamp() <= $this->get_blocked_until();
	}
	
	private function block_user() {
		$block_expiry_time = $this->time->get_current_timestamp_plus_seconds( self::TWOFAS_LIGHT_USER_BLOCK_PERIOD );
